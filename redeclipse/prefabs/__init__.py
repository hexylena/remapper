...
class tree_house_thingy(Room):
    _height = 1

    def render(self, world, xmap):
        self.light(xmap)
        self.x('cube', world, SELF + FineVector(0, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(2, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(3, 0, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(4, 0, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(5, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(6, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 0, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 1, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 1, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(2, 1, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(3, 1, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(4, 1, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(5, 1, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(6, 1, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 1, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 2, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 2, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(2, 2, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(3, 2, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(4, 2, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(5, 2, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(6, 2, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(7, 2, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 3, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(1, 3, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(2, 3, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(3, 3, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(4, 3, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(5, 3, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(6, 3, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(7, 3, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(0, 4, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(1, 4, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(2, 4, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(3, 4, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(4, 4, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(5, 4, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(6, 4, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(7, 4, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(0, 5, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 5, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(2, 5, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(3, 5, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(4, 5, 0), tex=TEXMAN.get('auto_29'))
        self.x('cube', world, SELF + FineVector(5, 5, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(6, 5, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(7, 5, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 6, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 6, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(2, 6, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(3, 6, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(4, 6, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(5, 6, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(6, 6, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 6, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(1, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(2, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(3, 7, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(4, 7, 0), tex=TEXMAN.get('auto_30'))
        self.x('cube', world, SELF + FineVector(5, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(6, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 7, 0), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 0, 1), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 0, 1), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 7, 1), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 7, 1), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 0, 2), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 0, 2), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 7, 2), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 7, 2), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 0, 3), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 0, 3), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 7, 3), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 7, 3), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 0, 4), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 0, 4), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 7, 4), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(7, 7, 4), tex=TEXMAN.get('auto_2'))
        self.x('cube', world, SELF + FineVector(0, 0, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(1, 0, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(6, 0, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(7, 0, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(0, 1, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(7, 1, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(0, 6, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(7, 6, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(0, 7, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(1, 7, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(6, 7, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(7, 7, 5), tex=TEXMAN.get('auto_12'))
        self.x('cube', world, SELF + FineVector(1, 0, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(2, 0, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(5, 0, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(6, 0, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(0, 1, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(1, 1, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(6, 1, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(7, 1, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(0, 2, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(7, 2, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(0, 5, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(7, 5, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(0, 6, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(1, 6, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(6, 6, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(7, 6, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(1, 7, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(2, 7, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(5, 7, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(6, 7, 6), tex=TEXMAN.get('auto_85'))
        self.x('cube', world, SELF + FineVector(2, 0, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(3, 0, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(4, 0, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(5, 0, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(1, 1, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(2, 1, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(5, 1, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(6, 1, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(0, 2, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(1, 2, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(3, 2, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(4, 2, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(6, 2, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(7, 2, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(0, 3, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(2, 3, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(3, 3, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(4, 3, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(5, 3, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(7, 3, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(0, 4, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(2, 4, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(3, 4, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(4, 4, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(5, 4, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(7, 4, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(0, 5, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(1, 5, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(3, 5, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(4, 5, 7), tex=TEXMAN.get('auto_19'))
        self.x('cube', world, SELF + FineVector(6, 5, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(7, 5, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(1, 6, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(2, 6, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(5, 6, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(6, 6, 7), tex=TEXMAN.get('auto_26'))
        self.x('cube', world, SELF + FineVector(2, 7, 7), tex=TEXMAN.get('auto_26'))
