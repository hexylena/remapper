...
class TestRoom2(Room):
    def render(self, world, xmap):
        ...
        self.x('wall', world, SELF, SOUTH, tex=TEXMAN.get_c('accent'))
        self.x('wall', world, SELF, NORTH, tex=TEXMAN.get_c('accent'))
        self.x('wall', world, SELF, WEST, tex=TEXMAN.get_c('accent'))
        self.x('wall', world, SELF, EAST, tex=TEXMAN.get_c('accent'))
